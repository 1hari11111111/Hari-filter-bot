...
auth_grp = environ.get('AUTH_GROUP', '-1002249464432')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001812797837')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002249464432')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002249464432'))
